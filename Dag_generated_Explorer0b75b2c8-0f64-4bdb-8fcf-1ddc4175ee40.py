...
args = {
    "project_id": "Dag_generated_Explorer0b75b2c8-0f64-4bdb-8fcf-1ddc4175ee40",
}

dag = DAG(
    "Dag_generated_Explorer0b75b2c8-0f64-4bdb-8fcf-1ddc4175ee40",
    default_args=args,
...
op_6bee4443f69b4a4e9a933a0fddbbf12e = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "EXPLORER_RUN_NAME": "Dag_generated_Explorer0b75b2c8-0f64-4bdb-8fcf-1ddc4175ee40",
    },
    config_file=None,
...
op_c767853a248e4cf5bcce1956efa05946 = KubernetesPodOperator(
    task_id="c767853a248e4cf5bcce1956efa05946",
    name="c767853a248e4cf5bcce1956efa05946",
    namespace="default",
    cmds=["sh", "-c"],
    arguments=[
        "mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && curl -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/krishnadhoundiyal/explorer/main/runnotebook.py --output runnotebook.py && curl -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/krishnadhoundiyal/explorer/main/requirements-explorer.txt --output requirements.txt && python3 -m pip install packaging && python -m pip install -r requirements.txt && python3 -m pip freeze > requirements-current.txt && python3 runnotebook.py --endpoint storage.googleapis.com --bucket explorer-cloud-storage --directory 'Dag_generated_Explorer0b75b2c8-0f64-4bdb-8fcf-1ddc4175ee40' --dependencies-archive 'Part 1 - Data Cleaning-c767853a248e4cf5bcce1956efa05946.tar.gz' --file '/Part 1 - Data Cleaning.ipynb' --inputs 'data/noaa-weather-data-jfk-airport/jfk_weather.csv' --outputs 'data/noaa-weather-data-jfk-airport/jfk_weather_cleaned.csv' "
    ],
    image="docker.io/amancevice/pandas:1.1.1",
    env_vars={
        "d": "c",
...
op_6bee4443f69b4a4e9a933a0fddbbf12e >> op_c767853a248e4cf5bcce1956efa05946
