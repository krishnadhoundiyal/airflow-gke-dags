...
op_29b1d1bae54d48b5b0b3e66cded365ac = KubernetesPodOperator(
    ...
    namespace='default',
    cmds=["sh", "-c"],
    arguments=["mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && curl -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/krishnadhoundiyal/explorer/main/CreateNoteBookEnv.py --output runnotebook.py && curl -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/krishnadhoundiyal/explorer/main/requirements-explorer.txt --output requirements.txt && python3 -m pip install packaging && python3 -m pip freeze > requirements-current.txt && python3 runnotebook.py --cos-endpoint https://storage.googleapis.com --cos-bucket explorer-cloud-storage --cos-directory 'Dag_generated_Explorer2b2e8e29-b074-4907-b4c2-15a15bac17cb4343' --cos-dependencies-archive 'Part 1 - Data Cleaning-29b1d1bae54d48b5b0b3e66cded365ac.tar.gz' --file 'Part 1 - Data Cleaning.ipynb' --inputs 'data/noaa-weather-data-jfk-airport/jfk_weather.csv' --outputs 'data/noaa-weather-data-jfk-airport/jfk_weather_cleaned.csv' "
    ],
    env_vars={
        "d": "g",
        "RUNTIME_ENV": "NotebookOp",
...
op_3be3433fa22242d1a3fbeeeb7158b571 = KubernetesPodOperator(
    ...
    namespace='default',
    cmds=["sh", "-c"],
    arguments=["mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && curl -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/krishnadhoundiyal/explorer/main/CreateNoteBookEnv.py --output runnotebook.py && curl -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/krishnadhoundiyal/explorer/main/requirements-explorer.txt --output requirements.txt && python3 -m pip install packaging && python3 -m pip freeze > requirements-current.txt && python3 runnotebook.py --cos-endpoint https://storage.googleapis.com --cos-bucket explorer-cloud-storage --cos-directory 'Dag_generated_Explorer2b2e8e29-b074-4907-b4c2-15a15bac17cb4343' --cos-dependencies-archive 'Part 3 - Time Series Forecasting-3be3433fa22242d1a3fbeeeb7158b571.tar.gz' --file 'Part 3 - Time Series Forecasting.ipynb' --inputs 'data/noaa-weather-data-jfk-airport/jfk_weather_cleaned.csv;data/noaa-weather-data-jfk-airport/jfk_weather.csv' "
    ],
    env_vars={
        "t": "v",
        "RUNTIME_ENV": "NotebookOp",
