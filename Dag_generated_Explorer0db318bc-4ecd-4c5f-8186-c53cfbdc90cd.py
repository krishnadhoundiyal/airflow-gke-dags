...
args = {
    "project_id": "Dag_generated_Explorer0db318bc-4ecd-4c5f-8186-c53cfbdc90cd",
}

dag = DAG(
    "Dag_generated_Explorer0db318bc-4ecd-4c5f-8186-c53cfbdc90cd",
    default_args=args,
...
op_84cabebf1cda4c089cacbcb5d9b1d286 = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "EXPLORER_RUN_NAME": "Dag_generated_Explorer0db318bc-4ecd-4c5f-8186-c53cfbdc90cd",
    },
    config_file=None,
...
op_51a9c44a7c044b469da750f38ae3e7a4 = KubernetesPodOperator(
    task_id="51a9c44a7c044b469da750f38ae3e7a4",
    name="51a9c44a7c044b469da750f38ae3e7a4",
    namespace="default",
    cmds=["sh", "-c"],
    arguments=[
        "mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && curl -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/krishnadhoundiyal/explorer/main/runnotebook.py --output runnotebook.py && curl -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/krishnadhoundiyal/explorer/main/requirements-explorer.txt --output requirements.txt && python3 -m pip install packaging && python -m pip install -r requirements.txt && python3 -m pip freeze > requirements-current.txt && python3 runnotebook.py --endpoint storage.googleapis.com --bucket explorer-cloud-storage --directory 'Dag_generated_Explorer0db318bc-4ecd-4c5f-8186-c53cfbdc90cd' --dependencies-archive 'Part 1 - Data Cleaning-51a9c44a7c044b469da750f38ae3e7a4.tar.gz' --file '/Part 1 - Data Cleaning.ipynb' --inputs 'data/noaa-weather-data-jfk-airport/jfk_weather.csv' --outputs 'data/noaa-weather-data-jfk-airport/jfk_weather_cleaned.csv' "
    ],
    image="docker.io/amancevice/pandas:1.1.1",
    env_vars={
        "d": "d",
...
op_84cabebf1cda4c089cacbcb5d9b1d286 >> op_51a9c44a7c044b469da750f38ae3e7a4
