...
args = {
    "project_id": "Dag_generated_Explorer3a97d893-e053-4372-bf6c-7a46a2ec5c7c",
}

dag = DAG(
    "Dag_generated_Explorer3a97d893-e053-4372-bf6c-7a46a2ec5c7c",
    default_args=args,
...
op_ebfd3452914a4a789bff4be3b414108a = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "EXPLORER_RUN_NAME": "Dag_generated_Explorer3a97d893-e053-4372-bf6c-7a46a2ec5c7c",
    },
    config_file=None,
...
op_9b9cad524dbb483bb9a8aa2186c6563b = KubernetesPodOperator(
    task_id="9b9cad524dbb483bb9a8aa2186c6563b",
    name="9b9cad524dbb483bb9a8aa2186c6563b",
    namespace="default",
    cmds=["sh", "-c"],
    arguments=[
        "mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && curl -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/krishnadhoundiyal/explorer/main/runnotebook.py --output runnotebook.py && curl -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/krishnadhoundiyal/explorer/main/requirements-explorer.txt --output requirements.txt && python3 -m pip install packaging && python -m pip install -r requirements.txt && python3 -m pip freeze > requirements-current.txt && python3 runnotebook.py --endpoint storage.googleapis.com --bucket explorer-cloud-storage --directory 'Dag_generated_Explorer3a97d893-e053-4372-bf6c-7a46a2ec5c7c' --dependencies-archive 'Part 1 - Data Cleaning-9b9cad524dbb483bb9a8aa2186c6563b.tar.gz' --file '/Part 1 - Data Cleaning.ipynb' --inputs 'data/noaa-weather-data-jfk-airport/jfk_weather.csv' --outputs 'data/noaa-weather-data-jfk-airport/jfk_weather_cleaned.csv' "
    ],
    image="docker.io/amancevice/pandas:1.1.1",
    env_vars={
        "d": "s",
...
op_ebfd3452914a4a789bff4be3b414108a >> op_9b9cad524dbb483bb9a8aa2186c6563b
